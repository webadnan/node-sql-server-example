        ...
        return {
            ...
            confirm: function (msg, buttonTexts) {
                ...
                var lines = [
                    ...
                    '<div class="modal-footer">',
                    `  <button class="btn btn-primary" ng-click="ok()">${texts[0]}</button>`,
                    `  <button class="btn btn-default" ng-click="cancel()">${texts[1]}</button>`,
                    '</div>'
                ];
                var template = lines.join('')
                PmsModal.open({
                ...
                for (var i = 0; i < options.length; i++) {
                    ...
                    var html =
                        `<div class="form-group">
                          <label for="${option.key}" class="col-sm-2 control-label">${option.label}</label>
                          <div class="col-sm-10">
                            <input id="${option.key}" type="email" class="form-control" placeholder="${option.placeholder}" value="${option.defaultText}">
                          </div>
                        </div>`
                    inputHtml.push(html);
                }
